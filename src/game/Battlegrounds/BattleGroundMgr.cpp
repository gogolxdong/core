...
void BattleGroundQueue::Update(BattleGroundTypeId bgTypeId, BattleGroundBracketId bracket_id)
{
    ...
    q_max_level = 61;
    {
        ...
        if (CheckPremadeMatch(bracket_id, MinPlayersPerTeam, MaxPlayersPerTeam))
        {
            ...
            BattleGround * bg2 = sBattleGroundMgr.GetBattleGroundsBegin(BATTLEGROUND_WS)->second;
            uint32 instanceId = bg2->GetInstanceID();
            sLog.outError("instanceId: %u", instanceId);
