...
void WorldSession::HandleBattleFieldPortOpcode(WorldPacket& recv_data)
{
    ...
    sLog.outError("ginfo.IsInvitedToBGInstanceGUID: %d\n",ginfo.IsInvitedToBGInstanceGUID);
    BattleGround *bg = sBattleGroundMgr.GetBattleGround(ginfo.IsInvitedToBGInstanceGUID, bgTypeId);
    BattleGroundSet::iterator begin = sBattleGroundMgr.GetBattleGroundsBegin(bgTypeId);
    const  uint32 beginInstanceId = begin->second->GetInstanceID();
