...
ChatCommand * ChatHandler::getCommandTable()
{
    ...
    {
        { "alterac",    SEC_GAMEMASTER,      false, &ChatHandler::HandleBattleBotAddAlteracCommand, "", nullptr },
        { "arathi",     SEC_GAMEMASTER,      false, &ChatHandler::HandleBattleBotAddArathiCommand,  "", nullptr },
        { "warsong",    SEC_GAMEMASTER,      false, &ChatHandler::HandleBattleBotAddWarsongCommand, "", nullptr },
        { nullptr,      0,                      false, nullptr,                                        "", nullptr },
    };
    static ChatCommand battleBotCommandTable[] =
    {
        { "add",          SEC_GAMEMASTER,    false, nullptr,            "Add a new bot", battleBotAddCommandTable },
        { "remove",       SEC_GAMEMASTER,    false, &ChatHandler::HandleBattleBotRemoveCommand,       "", nullptr },
        { "showpath",     SEC_GAMEMASTER,    false, &ChatHandler::HandleBattleBotShowPathCommand,     "", nullptr },
        { "showallpaths", SEC_GAMEMASTER,    false, &ChatHandler::HandleBattleBotShowAllPathsCommand, "", nullptr },
        { nullptr,        0,                    false, nullptr,                                          "", nullptr },
    };
    ...
    static ChatCommand debugCommandTable[] =
    {
        ...
        { "bg",             SEC_GAMEMASTER,  true,  &ChatHandler::HandleDebugBattlegroundCommand,        "", nullptr },
    ...
    {
        { "creature",       SEC_PLAYER, false, &ChatHandler::HandleGoCreatureCommand,          "", nullptr },
        { "graveyard",      SEC_PLAYER, false, &ChatHandler::HandleGoGraveyardCommand,         "", nullptr },
        { "grid",           SEC_PLAYER, false, &ChatHandler::HandleGoGridCommand,              "", nullptr },
        { "object",         SEC_PLAYER, false, &ChatHandler::HandleGoObjectCommand,            "", nullptr },
        { "target",         SEC_PLAYER, false, &ChatHandler::HandleGoTargetCommand,            "", nullptr },
        { "taxinode",       SEC_PLAYER, false, &ChatHandler::HandleGoTaxinodeCommand,          "", nullptr },
        { "trigger",        SEC_PLAYER, false, &ChatHandler::HandleGoTriggerCommand,           "", nullptr },
        { "zonexy",         SEC_PLAYER, false, &ChatHandler::HandleGoZoneXYCommand,            "", nullptr },
        { "xy",             SEC_PLAYER, false, &ChatHandler::HandleGoXYCommand,                "", nullptr },
        { "xyz",            SEC_PLAYER, false, &ChatHandler::HandleGoXYZCommand,               "", nullptr },
        { "xyzo",           SEC_PLAYER, false, &ChatHandler::HandleGoXYZOCommand,              "", nullptr },
        // Nostalrius
        { "forward",        SEC_PLAYER, false, &ChatHandler::HandleGoForwardCommand,           "", nullptr },
        { "up",             SEC_PLAYER, false, &ChatHandler::HandleGoUpCommand,                "", nullptr },
        { "relative",       SEC_PLAYER, false, &ChatHandler::HandleGoRelativeCommand,          "", nullptr },
        // Battleground join
        { "warsong",        SEC_PLAYER, false, &ChatHandler::HandleGoWarsongCommand,           "", nullptr },
        { "arathi",         SEC_PLAYER, false, &ChatHandler::HandleGoArathiCommand,            "", nullptr },
    ...
    static ChatCommand learnCommandTable[] =
    {
        ...
        { "all_crafts",     SEC_PLAYER,     false, &ChatHandler::HandleLearnAllCraftsCommand,      "", nullptr },
        { "all_default",    SEC_TICKETMASTER,   false, &ChatHandler::HandleLearnAllDefaultCommand,     "", nullptr },
        { "all_lang",       SEC_PLAYER,      false, &ChatHandler::HandleLearnAllLangCommand,        "", nullptr },
        { "all_myclass",    SEC_GAMEMASTER,      false, &ChatHandler::HandleLearnAllMyClassCommand,     "", nullptr },
        { "all_myspells",   SEC_PLAYER,      false, &ChatHandler::HandleLearnAllMySpellsCommand,    "", nullptr },
        { "all_mytalents",  SEC_DEVELOPER,      false, &ChatHandler::HandleLearnAllMyTalentsCommand,   "", nullptr },
        { "all_mytaxis",    SEC_PLAYER,   false, &ChatHandler::HandleLearnAllMyTaxisCommand,     "", nullptr },
    ...
    static ChatCommand modifyCommandTable[] =
    {
        ...
        { "gender",         SEC_PLAYER,     false, &ChatHandler::HandleModifyGenderCommand,        "", nullptr },
        ...
        { "intellect",      SEC_GAMEMASTER,    false, &ChatHandler::HandleModifyIntellectCommand,     "", nullptr },
        { "spirit",         SEC_GAMEMASTER,    false, &ChatHandler::HandleModifySpiritCommand,        "", nullptr },
        ...
        { "xprate",         SEC_GAMEMASTER,         false, &ChatHandler::HandleModifyXpRateCommand,        "", nullptr },
        { "hairstyle",      SEC_PLAYER,    false, &ChatHandler::HandleModifyHairStyleCommand,     "", nullptr },
        { "haircolor",      SEC_PLAYER,    false, &ChatHandler::HandleModifyHairColorCommand,     "", nullptr },
        { "skincolor",      SEC_PLAYER,    false, &ChatHandler::HandleModifySkinColorCommand,     "", nullptr },
        { "accessories",    SEC_PLAYER,    false, &ChatHandler::HandleModifyAccessoriesCommand,   "", nullptr },
        { nullptr,          0,                  false, nullptr,                                        "", nullptr }
    };
    ...
    static ChatCommand resetCommandTable[] =
    {
        ...
        { "talents",        SEC_PLAYER,     true,  &ChatHandler::HandleResetTalentsCommand,        "", nullptr },
    ...
    static ChatCommand commandTable[] =
    {
        ...
        { "reset",          SEC_PLAYER,     true, nullptr,                                         "", resetCommandTable    },
        ...
        { "battlebot",      SEC_GAMEMASTER,  false, nullptr,                      "Manage battle bots", battleBotCommandTable},
